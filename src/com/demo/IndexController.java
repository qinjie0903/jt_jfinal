...
public class IndexController extends Controller {
	...
	public void index() {
		...
		/*
		 * String value1 = getPara("key1"); String value2 = getPara("key2");
		 * 
		 * System.out.println("value1===="+value1);
		 * System.out.println("value2===="+value2);
		 * 
		 * String para = getPara(); System.out.println("para==="+para);
		 * 
		...
		/*
		 * String title =getPara("ar1.title"); String subtitle
		 * =getPara("subtitle"); String content =getPara("content");
		 * 
		...
		/*
		 * Article article =
		 * getBean(Article.class,"");//在html页面中的name属性设置为ar1而不是javabean类名;
		 * 传入""则相当于前缀没有 //Article article =
		 * getModel(Article.class,"");//用法和getBean一样，
		...
		String s2 = getRequest().getHeader("Accept");
		System.out.println("----"+s1);
		System.out.println("----"+s2);
		//自定义
		getResponse().setHeader("jimmy", "test hello");
		
		render("/index.html");
	}

	/*
	 * public void jpress(){ System.out.println("xxxx") renderText("xxxxx"); }
	 */
